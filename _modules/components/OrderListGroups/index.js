...
var OrderListGroups = function OrderListGroups(props) {
  var _props$combineTabs, _configs$combine_pend, _configs$logistic_mod, _orderGroupStatusCust, _orderGroupStatusCust2, _orderGroupStatusCust3, _orderGroupStatusCust4, _orderGroupStatusCust5, _paginationSettings$p, _ordersGroup$currentT18;
  ...
  (0, _react.useEffect)(function () {
    var _socket$socket, _session$user7, _session$user8, _socket$socket2, _socket$socket2$_call, _socket$socket2$_call2, _socket$socket3, _socket$socket3$_call, _socket$socket3$_call2, _socket$socket4, _socket$socket4$_call, _socket$socket4$_call2;
    ...
    if (socket !== null && socket !== void 0 && (_socket$socket3 = socket.socket) !== null && _socket$socket3 !== void 0 && (_socket$socket3$_call = _socket$socket3._callbacks) !== null && _socket$socket3$_call !== void 0 && (_socket$socket3$_call2 = _socket$socket3$_call.$update_order) !== null && _socket$socket3$_call2 !== void 0 && _socket$socket3$_call2.find(function (func) {
      return (func === null || func === void 0 ? void 0 : func.name) !== 'handleUpdateOrder';
    })) {
      socket.on('update_order', handleUpdateOrder);
    }
    if (socket !== null && socket !== void 0 && (_socket$socket4 = socket.socket) !== null && _socket$socket4 !== void 0 && (_socket$socket4$_call = _socket$socket4._callbacks) !== null && _socket$socket4$_call !== void 0 && (_socket$socket4$_call2 = _socket$socket4$_call.$message) !== null && _socket$socket4$_call2 !== void 0 && _socket$socket4$_call2.find(function (func) {
